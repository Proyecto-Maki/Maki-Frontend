...
import "../styles/categories_home.css";
    ...
    <div className="absolute-section-categories">
      <div className="section-categories">
        <div className="container-fluid-cat">
          <h2 className="hd-cat-home">
            Conoce nuestras categorías de <p> mascotas!</p>
          </h2>

          <Slider {...settings} className="categories-slider-main-home">
            {categories.map((category, index) => (
              <button
                key={index}
                className={`item-cat-home ${
          ...
          {/*subcategoria*/}
          {categoriaPrincipal && (
            <div className="subcategories-slider-container-home">
              <h3>
