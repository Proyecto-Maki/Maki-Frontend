            ...
            <div className="contenedor-resumen-adopcion">
                <div className="info-adopcion-card">
                    <div className="fila-superior-adopcion">
                        <h4 className="adopcion-titulo">{solicitudAdopcion.publicacion.titulo}</h4>
                    ...
                    <div className="fila-inferior-adopcion">
                        <div className="boton-y-nombre">
                            <div className="adopcion-nombre-completo">
                                <p className="adopcion-nombre-cliente"><span className="label-nombre-adopcion">Nombre cliente:</span> <span className="cliente-nombre">{solicitudAdopcion.cliente.primer_nombre} {solicitudAdopcion.cliente.segundo_nombre}</span></p>
                                <p className="adopcion-apellido-cliente"><span className="label-apellido-adopcion">Apellido cliente:</span> <span className="cliente-apellido">{solicitudAdopcion.cliente.primer_apellido} {solicitudAdopcion.cliente.segundo_apellido}</span></p>
                            </div>
                        </div>
                ...
                <div className="cards-container-container">
                    ...
                    <div className="card-solicitud-adopcion">
                        <div className="card-content-mascota">
                            <h2 className="h2-tarjetas-adopcion">{solicitudAdopcion.publicacion.titulo}</h2>
                            <div className="card-content-mascota-interior">
                                <div className="image-container">
                                    <img src={dogImage} alt={solicitudAdopcion.publicacion.mascota.nombre} />
                                </div>
                                <div className="mascota-details">
                                    <div className="columna-izquierda">
                                        ...
                                        <p>{solicitudAdopcion.publicacion.mascota.sexo === 'M' ? 'Macho' : 'Hembra'}</p>
                                        <p>{solicitudAdopcion.publicacion.mascota.tamano === 'P' ? 'Pequeño' : solicitudAdopcion.publicacion.mascota.tamano === 'M' ? 'Mediano' : 'Grande'}</p>
                                        <p>{solicitudAdopcion.publicacion.mascota.raza}</p>
                                    </div>
                                    <div className="columna-derecha">
                                        <p><strong>Edad:</strong> {solicitudAdopcion.publicacion.mascota.edad} año(s)</p>
                                        <p><strong>Peso:</strong> {solicitudAdopcion.publicacion.mascota.peso} kg</p>
                                        <p><strong>Dirección:</strong> {solicitudAdopcion.publicacion.detalle_direccion.direccion}</p>
                                        <p><strong>Localidad:</strong> {solicitudAdopcion.publicacion.detalle_direccion.localidad}</p>
                                    </div>
                    ...
                    <div className="card-informacion-cliente">
                        ...
                        <div className="card-content-cliente">
                            <h2 className="h2-tarjetas-adopcion">{solicitudAdopcion.cliente.primer_nombre + " " + solicitudAdopcion.cliente.segundo_nombre + " " + solicitudAdopcion.cliente.primer_apellido + " " + solicitudAdopcion.cliente.segundo_apellido}</h2>
                            <div className="card-content-cliente-interior">
                                ...
                                <div className="cliente-details">
                                    <div className="columna-izquierda">
                                        <p><strong>Cédula:</strong> CC {solicitudAdopcion.cliente.cedula}</p>
                                        <p><strong>Correo:</strong> {solicitudAdopcion.cliente.email}</p>
                                        <p><strong>Teléfono:</strong> {solicitudAdopcion.cliente.telefono}</p>
                                        <p><strong>Localidad:</strong> {solicitudAdopcion.cliente.localidad} </p>
                                    </div>
                                    <div className="columna-derecha">
                                        <p><strong>Código Postal:</strong> {solicitudAdopcion.cliente.codigo_postal ? (solicitudAdopcion.cliente.codigo_postal) : ("No hay código postal")}  </p>
                                        <p><strong>Dirección:</strong> {solicitudAdopcion.cliente.direccion}</p>
                                        <p><strong>Fecha de nacimiento:</strong> {solicitudAdopcion.cliente.fecha_nacimiento} </p>
                                    </div>
                                </div>
                            </div>
                        </div>
