        ...
        <>
            ...
            <div className="background-container">
                ...
                <div className="register-pet-container">
                    <form>
                        <h2>¡Hola! Eres dueño de mascotas ¡Nos gustaría que la registraras!</h2>
                        <div className="form-group">
                            <label className="label-register-pet-name">¿Cómo se llama tu mascota?</label>
                        ...
                        <div className="form-row">
                            <div className="form-group col-md-6">
                                <label className="label-register-pet-type">¿Qué tipo de mascota tienes?</label>
                                <select
                        ...
                        <div className="form-row">
                            <div className="form-group col-md-6">
                                <label htmlFor="input-pet-age" className="label-register-pet-age">Edad</label>
                                <input
                                    type="number"
                            ...
                            <div className="form-group col-md-4">
                                <label htmlFor="input-pet-size" className="label-register-pet-size">Tamaño</label>
                                <select
                                    id="input-pet-size"
                            ...
                            <div className="form-group col-md-2">
                                <label htmlFor="input-pet-weight" className="label-register-pet-weight">Peso</label>
                                <input
                                    type="text"
