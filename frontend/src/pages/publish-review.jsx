...
const PublishReview = () => {
  ...
  const { origen, contenido } = location.state;

  useEffect(() => {
    if (!origen) {
      navigate("/user-profile");
    } else if (origen === "info-producto") {
      setCreateUrl("resenas-productos/create/");
    } else if (origen === "info-cuidador") {
      setCreateUrl("resenas-cuidadores/create/");
    }
  }, [origen, navigate]);
      ...
      <div className="background-container-publish-review">
        <div className="publish-review-container">
          ...
          <div className="publish-review-user-info">
            ...
            <p className="publish-review-date">
          ...
          <div className="publish-review-rating-section">
            ...
            <div className="publish-review-stars">
              {[1, 2, 3, 4, 5].map((star) => (
                <span
                  key={star}
                  className={`publish-review-star ${
                    star <= rating ? "selectedS" : ""
                  }`}
