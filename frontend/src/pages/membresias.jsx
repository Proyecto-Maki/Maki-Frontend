...
function Membresias() {
  ...
  const user_id = sessionStorage.getItem("user_id"); // Obtener el user_id
  ...
  const handleBuyMembership = (plan) => {
    ...
    api
      ...
      .then((response) => {
        //console.("✅ Respuesta de Mercado Pago:", response.data);
        if (response.data.init_point) {
          window.location.href = response.data.init_point; // Redirigir a Mercado Pago
        } else {
          console.error("Error: No se recibió el enlace de pago");
        }
      })
      .catch((error) => {
        ...
        <div className="background-membership">
          <div className="membership-container">
            <div className="logo-membership">
              ...
              <h3 className="membership-text">
                Ofrecemos los siguientes planes con los siguientes beneficios
                para tu fundación de mascotas
              </h3>
            </div>
              ...
              <div className="table-wrapper-membership">
                <div className="table-membership">
                  ...
                  <div className="row-membership header">
                    <div className="cell">
                      Podrás ver y comprar nuestros productos.
                    </div>
                  ...
                  <div className="row-membership">
                    <div className="cell">
                      Podrás recibir donaciones de nuestros clientes.
                    </div>
                    <div className="cell column-personal">
                      <img
                        src={paw}
                  ...
                  <div className="row-membership header">
                    <div className="cell">
                      Podrás publicar tus animales en adopción en nuestra
                      plataforma.
                    </div>
                    <div className="cell column-personal">
                      <img
                  ...
                  <div className="row-membership price">
                    ...
                    <button
                      className="price-peludos"
                      onClick={() => handleBuyMembership("Peludos")}
                    >
                      $26.000 COP
                    </button>
                  </div>
